...
def create_app():
    ...
    global connection
    # mysql = MySQL(app)
    connection = mysql.connector.connect(host="mysql", user="adminccs", password = 'ccstu_2022', database='curriculum_dataset')
